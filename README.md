...
You can use the
[ConcurrentChildScopes](http://cowwoc.github.io/pouch/2.2/docs/api/com/github/cowwoc/pouch/ConcurrentChildScopes.html)
...
For example,
[ConcurrentLazyFactory](http://cowwoc.github.io/pouch/2.2/docs/api/com/github/cowwoc/pouch/ConcurrentLazyFactory.html)
is the thread-safe equivalent
of [LazyFactory](http://cowwoc.github.io/pouch/2.2/docs/api/com/github/cowwoc/pouch/LazyFactory.html).
